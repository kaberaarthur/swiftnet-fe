...
var InputHidden = function (props) {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement("input", { "aria-label": "fui-hidden-input", style: { display: "none" }, ref: inputRef, onChange: onChange, type: "file", accept: accept, multiple: multiple })));
};
...
var DropzoneChildren = function (props) {
    ...
    if (children && !isEmptyArray) {
        return (React__namespace.createElement("div", { className: "files-ui-dropzone-children-container" }, children));
    }
    else
        return (React__namespace.createElement("div", { className: "files-ui-dropzone-children-container" },
...
var DropzoneDisabledLayer = function (props) {
    ...
    if (open) {
        return (React__namespace.createElement("div", { style: style, className: finalDisabledLayerClassName, onDrop: handleDrop, onDragOver: handleDrag, onClick: handleClick }));
    }
    else {
        return React__namespace.createElement(React__namespace.Fragment, null);
    }
...
var Cancel = function (props) {
    ...
    return (React__namespace.createElement("svg", { style: onClick ? __assign$1({}, __assign$1({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function (e) {
            handleClickUtil(e);
        ...
        React__namespace.createElement("path", { d: "M0 0h24v24H0V0z", fill: "none", opacity: ".87" }),
        React__namespace.createElement("path", { d: "M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8 8-3.59 8-8-3.59-8-8-8zm5 11.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z", fill: colorFill ? colorFill : "none", opacity: ".5" }),
        React__namespace.createElement("path", { d: "M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm3.59-13L12 10.59 8.41 7 7 8.41 10.59 12 7 15.59 8.41 17 12 13.41 15.59 17 17 15.59 13.41 12 17 8.41z" })));
};
...
var CheckCircle = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (React__default["default"].createElement("svg", { className: className || "", style: onClick ? __assign$1({}, __assign$1({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color ? color : "#000000" },
...
var Clean = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (React__default["default"].createElement("svg", { className: className || "", style: onClick ? __assign$1({}, __assign$1({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", enableBackground: "new 0 0 24 24", height: finalSize ? "".concat(finalSize, "px") : "24px", viewBox: "0 0 24 24", width: finalSize ? "".concat(finalSize, "px") : "24px", fill: color ? color : "#000000" },
        React__default["default"].createElement("g", null,
            React__default["default"].createElement("rect", { fill: "none", height: finalSize || "24", width: finalSize || "24" })),
        React__default["default"].createElement("g", null,
            React__default["default"].createElement("g", null,
                React__default["default"].createElement("path", { d: "M16,11h-1V3c0-1.1-0.9-2-2-2h-2C9.9,1,9,1.9,9,3v8H8c-2.76,0-5,2.24-5,5v7h18v-7C21,13.24,18.76,11,16,11z M11,3h2v8h-2V3 z M19,21h-2v-3c0-0.55-0.45-1-1-1s-1,0.45-1,1v3h-2v-3c0-0.55-0.45-1-1-1s-1,0.45-1,1v3H9v-3c0-0.55-0.45-1-1-1s-1,0.45-1,1v3H5 v-5c0-1.65,1.35-3,3-3h8c1.65,0,3,1.35,3,3V21z" })))));
};
...
var Clear = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (React__namespace.createElement("svg", { className: className || "", style: onClick ? __assign$1({ cursor: "pointer" }, finalStyle) : finalStyle, xmlns: "http://www.w3.org/2000/svg", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color ? color : "#000000", onClick: function (e) {
            handleClickUtil(e);
            onClick === null || onClick === void 0 ? void 0 : onClick(e);
        } },
        React__namespace.createElement("path", { d: "M0 0h24v24H0V0z", fill: colorFill || "none" }),
        React__namespace.createElement("path", { d: "M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41z" })));
};
...
var CloudDone = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (React__namespace.createElement("svg", { className: className || "", style: onClick ? __assign$1({ cursor: "pointer" }, finalStyle) : finalStyle, enableBackground: "new 0 0 24 24", xmlns: "http://www.w3.org/2000/svg", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color || "#000000", onClick: function (e) {
            handleClickUtil(e);
            onClick === null || onClick === void 0 ? void 0 : onClick(e);
        } },
        React__namespace.createElement("path", { d: "M0 0h24v24H0V0z", fill: colorFill || "none" }),
        React__namespace.createElement("path", { d: "M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM19 18H6c-2.21 0-4-1.79-4-4 0-2.05 1.53-3.76 3.56-3.97l1.07-.11.5-.95C8.08 7.14 9.94 6 12 6c2.62 0 4.88 1.86 5.39 4.43l.3 1.5 1.53.11c1.56.1 2.78 1.41 2.78 2.96 0 1.65-1.35 3-3 3zm-9-3.82l-2.09-2.09L6.5 13.5 10 17l6.01-6.01-1.41-1.41z" })));
};
...
var DoDisturb = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (React__default["default"].createElement("svg", { className: className || "", style: onClick ? __assign$1({}, __assign$1({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", height: finalSize ? "".concat(finalSize, "px") : "24px", viewBox: "0 0 24 24", width: finalSize ? "".concat(finalSize, "px") : "24px", fill: color ? color : "#000000" },
...
var DownloadFile = function (props) {
    ...
    return (React__namespace.createElement("svg", { className: className || "", style: onClick ? __assign$1({ cursor: "pointer" }, finalStyle) : finalStyle, enableBackground: "new 0 0 24 24", xmlns: "http://www.w3.org/2000/svg", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color || "#000000", onClick: function (e) {
        ...
        React__namespace.createElement("g", null,
            React__namespace.createElement("rect", { fill: colorFill || "none", height: finalSize, width: finalSize })),
        React__namespace.createElement("g", null,
            React__namespace.createElement("path", { d: "M18,15v3H6v-3H4v3c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2v-3H18z M17,11l-1.41-1.41L13,12.17V4h-2v8.17L8.41,9.59L7,11l5,5 L17,11z" }))));
};
...
var InfoDisney = function (props) {
    ...
    return (React__namespace.createElement("svg", { 
        ...
        React__namespace.createElement("path", { d: "M22.378 0c2.412 0 3.618 1.642 3.618 3.523 0 2.349-2.095 4.522-4.822 4.522-2.284 0-3.616-1.35-3.553-3.582 0-1.877 1.586-4.462 4.757-4.462zM14.956 36c-1.904 0-3.299-1.174-1.967-6.343l2.185-9.166c0.38-1.465 0.443-2.054 0-2.054-0.571 0-3.040 1.012-4.504 2.011l-0.95-1.584c4.63-3.935 9.956-6.241 12.242-6.241 1.903 0 2.219 2.291 1.269 5.814l-2.504 9.634c-0.443 1.701-0.254 2.288 0.191 2.288 0.571 0 2.443-0.706 4.282-2.173l1.080 1.465c-4.504 4.585-9.423 6.349-11.324 6.349z" })));
};
...
var PlayIcon = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (React__default["default"].createElement("svg", { className: className || "", style: onClick ? __assign$1({ cursor: "pointer" }, finalStyle) : finalStyle, xmlns: "http://www.w3.org/2000/svg", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color ? color : "#000000", onClick: function (e) {
            handleClickUtil(e);
            onClick === null || onClick === void 0 ? void 0 : onClick(e);
        } },
        React__default["default"].createElement("path", { d: "M0 0h24v24H0V0z", opacity: ".9", fill: colorFill ? colorFill : "none" }),
        React__default["default"].createElement("path", { d: "M8 5v14l11-7L8 5z" })));
};
...
var Upload = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (React__default["default"].createElement("svg", { style: onClick ? __assign$1({}, __assign$1({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", enableBackground: "new 0 0 24 24", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color ? color : "#000000", className: className || "" },
        React__default["default"].createElement("g", null,
...
var UploadingProcess = function (props) {
    ...
    return (React__default["default"].createElement("svg", { className: finalClassname, style: onClick ? __assign$1({}, __assign$1({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", height: finalSize ? "".concat(finalSize, "px") : "24px", viewBox: "0 0 24 24", width: finalSize ? "".concat(finalSize, "px") : "24px", fill: color ? color : "#000000" },
        React__default["default"].createElement("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
        React__default["default"].createElement("path", { d: "M12 4V1L8 5l4 4V6c3.31 0 6 2.69 6 6 0 1.01-.25 1.97-.7 2.8l1.46 1.46C19.54 15.03 20 13.57 20 12c0-4.42-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6 0-1.01.25-1.97.7-2.8L5.24 7.74C4.46 8.97 4 10.43 4 12c0 4.42 3.58 8 8 8v3l4-4-4-4v3z" })));
};
...
var Visibility = function (props) {
    ...
    return (React__default["default"].createElement("svg", { className: className || "", style: onClick ? __assign$1({ cursor: "pointer" }, finalStyle) : finalStyle, xmlns: "http://www.w3.org/2000/svg", height: "".concat(finalSize, "px"), viewBox: "0 0 24 24", width: "".concat(finalSize, "px"), fill: color ? color : "#000000", onClick: function (e) {
        ...
        React__default["default"].createElement("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
        React__default["default"].createElement("path", { d: "M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8 8-3.59 8-8-3.59-8-8-8z", 
            //opacity=".9"
...
var DropzoneHeader = function (props) {
    ...
    var makeHeader = function () {
        ...
        if (onUploadStart && urlPresent && numberOfValidFiles) {
            if (isUploading) {
                result.push(React__namespace.createElement(UploadingProcess, { spin: true, color: color }));
            }
            else {
                result.push(React__namespace.createElement(React__namespace.Fragment, null,
                    React__namespace.createElement(React__namespace.Fragment, null, DropzoneHeaderLocalizer.uploadFilesMessage),
                    React__namespace.createElement(Upload, { color: color, onClick: handleStartUploading })));
            }
            result.push(React__namespace.createElement(React__namespace.Fragment, null,
                ",",
                "\u00A0"));
        ...
        if (onClean) {
            result.push(React__namespace.createElement(Clean, { color: color, onClick: handleClean, size: "semi-medium" }));
        }
        if (onReset) {
            result.push(React__namespace.createElement(Cancel, { color: color, onClick: function () { return onReset === null || onReset === void 0 ? void 0 : onReset(); } }));
        }
        return result;
    };
    function handleClick(evt) {
    ...
    return (React__namespace.createElement("div", { className: finalClassName, onClick: handleClick, style: finalStyle }, makeHeader().map(function (HeaderItem, index) { return (React__namespace.createElement("span", { key: index, style: { display: "flex" } }, HeaderItem)); })));
};
...
var DropzoneFooter = function (props) {
    ...
    return (React__namespace.createElement("div", { className: finalClassName, onClick: handleClick, style: finalStyle }, customMessage ? (React__namespace.createElement(React__namespace.Fragment, null, customMessage)) : (React__namespace.createElement(React__namespace.Fragment, null, message
        ? message
        : !accept
            ? allowedTypesLabel
...
var MaterialButton = function (props) {
    ...
    if (finalMBClassNameDarkMode !== undefined || resetStyles)
        return React__namespace.createElement(href ? "a" : "button", __assign$1({ className: resetStyles && className ? className : finalMBClassNameDarkMode, "data-testid": href ? "dui-anchor" : "dui-button", onClick: handleClick, href: href, style: style, children: React__namespace.createElement("span", { className: "material-button-label" }, children), disabled: disabled }, rest));
    else
        return React__namespace.createElement(React__namespace.Fragment, null, "loading styes");
};
...
var DropzoneButtons = function (props) {
    ...
    return (React__namespace.createElement("div", { className: finalClassName, style: containerStyle }, actionButtonsList.map(function (actionButtonProps, index) {
        ...
        return (React__namespace.createElement(MaterialButton, { key: index, className: className, style: style, resetStyles: resetStyles, onClick: function (evt) { return onClick === null || onClick === void 0 ? void 0 : onClick(evt); }, disabled: disabled }, children || label));
    })));
};
...
var DropLayer = function (props) {
    ...
    return (React__namespace.createElement("div", { className: classNameLayer, onDragLeave: onDragLeave, onDrop: onDrop, 
        //onDragEnd={onDragEnd}
...
var Dropzone = function (props) {
    ...
    if (!finalDropzoneClassNameBorderClickable)
        return React__namespace.createElement(React__namespace.Fragment, null);
    return (React__namespace.createElement(React__namespace.Fragment, null,
        actionButtonsPosition === "before" && (React__namespace.createElement(DropzoneButtons, { disabled: disabled, abortButton: isUploading ? abortButton : undefined, onAbort: handleAbortUpload, deleteButton: deleteButton, onDelete: !isUploading ? handleReset : undefined, uploadButton: !isUploading && !autoUpload ? uploadButton : undefined, onUpload: !autoUpload ? function () { return uploadfiles(localFiles); } : undefined, cleanButton: validateFilesFlag && !isUploading && !autoClean
                ? cleanButton
                : undefined, onClean: handleClean, style: containerStyle, className: containerClassName, top: true })),
        React__namespace.createElement("div", __assign$1({ style: style, className: finalDropzoneClassNameBorderClickable }, rest, { onClick: handleClick, onDragOver: handleDragEnter, onDragLeave: !dropOnLayer ? handleDragLeave : undefined, onDrop: !dropOnLayer ? kamui : undefined }),
            !disableRipple && (React__namespace.createElement("div", { ref: fuiRippleRefAbs, className: "filesui-base-ripple-absolute", style: { borderRadius: style === null || style === void 0 ? void 0 : style.borderRadius } },
                React__namespace.createElement("div", { ref: fuiRippleRefRel, className: "filesui-base-ripple-relative" }))),
            React__namespace.createElement(React__namespace.Fragment, null, header ? (React__namespace.createElement(React__namespace.Fragment, null, customHeader ? (React__namespace.createElement(React__namespace.Fragment, null, customHeader)) : (React__namespace.createElement(DropzoneHeader, { firstClassName: headerClassName, color: completeAsureColor(color), style: styleHeader, className: classNameHeader, resetStyles: resetStylesHeader, borderRadius: styleBorderRadius, isUploading: isUploading && uploadingIconHedaer, onReset: !isUploading && deleteFilesHeader ? handleReset : undefined, maxFileSize: maxFileSize && maxFileSizeHeader ? maxFileSize : undefined, maxFiles: maxFiles && validFilesCountHeader ? maxFiles : undefined, localization: localization, urlPresent: shouldUpload && uploadFilesHeader, onUploadStart: !autoUpload && !uploadButton
                ...
                onClean: !cleanFilesHeader || isUploading || cleanButton || autoClean
                    ...
                    : (cleanFiles || onClean) && validateFilesFlag
                        ? handleClean
                        : undefined })))) : (React__namespace.createElement(React__namespace.Fragment, null))),
            React__namespace.createElement(DropzoneChildren, { label: label, localization: localization }, children),
            React__namespace.createElement(React__namespace.Fragment, null, customFooter ? (React__namespace.createElement(React__namespace.Fragment, null, customFooter)) : (React__namespace.createElement(React__namespace.Fragment, null, footer && (React__namespace.createElement(DropzoneFooter, __assign$1({ firstClassName: footerClassName, borderRadius: styleBorderRadius, accept: accept, message: isUploading ? localMessage : undefined, localization: localization }, footerConfig)))))),
            dropOnLayer && (React__namespace.createElement(DropLayer, { open: isDragging, className: !isDragging
                    ? dropLayerClassName
            ...
            React__namespace.createElement(InputHidden, { multiple: maxFiles ? maxFiles > 1 : true, accept: accept || "", inputRef: inputRef, onChange: handleChangeInput }),
            React__namespace.createElement(DropzoneDisabledLayer, { open: disabled, className: disabledLayerClassName })),
        actionButtonsPosition === "after" && (React__namespace.createElement(DropzoneButtons, { disabled: disabled, abortButton: isUploading ? abortButton : undefined, onAbort: handleAbortUpload, deleteButton: deleteButton, onDelete: !isUploading ? handleReset : undefined, uploadButton: !isUploading && !autoUpload ? uploadButton : undefined, onUpload: !autoUpload ? function () { return uploadfiles(localFiles); } : undefined, cleanButton: validateFilesFlag && !isUploading && !autoClean
                ? cleanButton
...
var FileInputButton = function (props) {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        actionButtonsPosition === "before" && (React__namespace.createElement(DropzoneButtons, { disabled: disabled, abortButton: isUploading ? abortButton : undefined, onAbort: handleAbortUpload, deleteButton: deleteButton, onDelete: !isUploading ? handleReset : undefined, uploadButton: !isUploading && !autoUpload ? uploadButton : undefined, onUpload: !autoUpload ? function () { return uploadfiles(localFiles); } : undefined, cleanButton: validateFilesFlag && !isUploading && !autoClean
                ? cleanButton
                : undefined, onClean: handleClean, style: containerStyle, className: containerClassName, top: true })),
        React__namespace.createElement(MaterialButton, __assign$1({ disabled: disabled, className: className, style: style, color: color, variant: variant, textTransform: textTransform, textColor: textColor, resetStyles: resetStyles, onClick: handleClick, disableRipple: disableRipple, darkMode: darkMode, id: inputButtonId }, rest), children || label),
        React__namespace.createElement(InputHidden, { multiple: maxFiles ? maxFiles > 1 : true, accept: accept || "", inputRef: inputRef, onChange: handleChangeInput }),
        actionButtonsPosition === "after" && (React__namespace.createElement(DropzoneButtons, { disabled: disabled, abortButton: isUploading ? abortButton : undefined, onAbort: handleAbortUpload, deleteButton: deleteButton, onDelete: !isUploading ? handleReset : undefined, uploadButton: !isUploading && !autoUpload ? uploadButton : undefined, onUpload: !autoUpload ? function () { return uploadfiles(localFiles); } : undefined, cleanButton: validateFilesFlag && !isUploading && !autoClean
                ? cleanButton
                : undefined, onClean: handleClean, style: containerStyle, className: containerClassName, top: false }))));
...
var BasePreparingLoader = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (React__namespace.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", width: "".concat(finalSize, "px"), height: "".concat(finalSize, "px"), style: finalStyle, viewBox: "0 0 100 100", preserveAspectRatio: "xMidYMid" },
        React__namespace.createElement("circle", { cx: "".concat(finalX), cy: "".concat(finalY), r: "".concat(finalRadius), fill: "none", stroke: color || "#14ff00", strokeWidth: "".concat(width || 8, "px"), strokeDasharray: "164.93361431346415 100.97787143782138" },
            React__namespace.createElement("animateTransform", { attributeName: "transform", type: "rotate", repeatCount: "indefinite", dur: "1s", values: "0 ".concat(finalX, " ").concat(finalX, ";360 ").concat(finalX, " ").concat(finalX), keyTimes: "0;1" }))));
};
...
var LoaderContainer = function (props) {
    ...
    return (React__namespace.createElement("div", { onClick: handleClick, className: className ? "".concat(finalClassName, " ").concat(className) : finalClassName, style: __assign$1(__assign$1({}, style), { height: finalSize, width: finalSize }) }, children));
};
...
var InfiniteLoader = function (props) {
    ...
    //text,
    size = props.size;
    return (React__namespace.createElement(LoaderContainer, { onClick: onClick, size: size },
        React__namespace.createElement(React__namespace.Fragment, null,
            React__namespace.createElement(BasePreparingLoader, { size: size }),
            React__namespace.createElement("div", { style: {
                ...
                } }, onClick && (React__namespace.createElement(Clear, { color: "rgba(255,255,255,0.75)", size: 45, onClick: onClick }))))));
};
...
var Layer = function (props) {
    ...
    if (visible)
        return (React__namespace.createElement("div", __assign$1({ className: finalClassName, style: style }, otherProps), children));
    else
        return React__namespace.createElement(React__namespace.Fragment, null);
};
...
var ImagePreview = function (props) {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null, src && source && (finalHeight || finalWidth) && (React__namespace.createElement("img", { 
        //onLoad={handleLoad}
...
var Avatar = function (props) {
    ...
    if (!finalClassNameBorder)
        ...
        return (React__namespace.createElement(React__namespace.Fragment, null,
            React__namespace.createElement("div", __assign$1({ className: "fui-avatar-main-container".concat(variant === "circle" ? " circle" : "", " ").concat(finalClassNameBorder), style: style }, rest),
                isUloading ? (React__namespace.createElement(Layer, { visible: true },
                    React__namespace.createElement("div", { className: "fui-avatar-label" },
                        React__namespace.createElement(InfiniteLoader, { size: 50 }),
                        uploadingLabel))) : src ? (React__namespace.createElement(ImagePreview, { className: "fui-avatar-image", src: src, alt: alt, onError: handleError, smartImgFit: smartImgFit })) : (React__namespace.createElement("div", { className: "fui-avatar-label" }, emptyLabel)),
                !readOnly && (React__namespace.createElement(React__namespace.Fragment, null,
                    !isUloading && (React__namespace.createElement("div", { className: "fui-avatar-label hide", onClick: handleClick }, src ? changeLabel : emptyLabel)),
                    React__namespace.createElement(InputHidden, { multiple: false, accept: accept || "image/*", onChange: handleChangeInput, inputRef: inputRef }))))));
    }
};
/**
 * creates a dynamic css sheet for avatar
...
var FileCardRightActions = function (props) {
    ...
    if (visible)
        return (React__namespace.createElement(React__namespace.Fragment, null,
            React__namespace.createElement("div", { className: "file-card-right-layer-header" }, isActive && deleteIcon && (React__namespace.createElement(Clear, { className: darkMode ? "files-ui-file-icon dark-mode" : "files-ui-file-icon", color: darkMode ? "#121212" : "rgba(255,255,255,0.851)", onClick: onDelete, size: "small", colorFill: "transparent" }))),
            React__namespace.createElement("div", { className: "file-card-right-layer-footer" }, isActive && (React__namespace.createElement(React__namespace.Fragment, null,
                imageIcon && (React__namespace.createElement(Visibility, { className: darkMode
                        ? "files-ui-file-icon dark-mode"
                        : "files-ui-file-icon", color: darkMode ? "#121212" : "rgba(255,255,255,0.851)", onClick: onSee, size: "small" })),
                videoIcon && (React__namespace.createElement(PlayIcon, { className: darkMode
                        ? "files-ui-file-icon dark-mode"
                        : "files-ui-file-icon", color: darkMode ? "#121212" : "rgba(255,255,255,0.851)", onClick: onWatch, size: "small" })),
                downloadIcon && (React__namespace.createElement(DownloadFile, { className: darkMode
                        ? "files-ui-file-icon dark-mode"
                        : "files-ui-file-icon", color: darkMode ? "#121212" : "rgba(255,255,255,0.851)", onClick: onDownload, size: "small" })),
                infoIcon && (React__namespace.createElement(InfoDisney, { className: darkMode
                        ? "files-ui-file-icon dark-mode"
...
var FileCardInfoLayer = function (props) {
    ...
    return (React__namespace.createElement("div", { className: "file-card-file-info" },
        React__namespace.createElement(Cancel, { style: { margin: 0, right: 5, top: 0, position: "absolute" }, color: "rgba(255,255,255,0.8)", onClick: onCloseInfo, colorFill: "black" }),
        React__namespace.createElement("div", { className: "heading" }, nameLabel),
        React__namespace.createElement("div", { className: "label" }, localName),
        React__namespace.createElement("div", { className: "heading" }, sizeLabel),
        React__namespace.createElement("div", { className: "label" }, sizeFormatted),
        React__namespace.createElement("div", { className: "heading" }, typeLabel),
        React__namespace.createElement("div", { className: "label" }, localType)));
};
...
var AbortedStatus = function (props) {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement(DoDisturb, { color: "#f44336", size: size || 65 }),
...
var EmptyStatus = function (props) {
    ...
    var finalHeight = !height
        ...
        : typeof height === "number"
            ...
            : height;
    return (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement("div", { style: { width: "100%", height: finalHeight } })));
};
...
var ErrorStatus = function (props) {
    ...
    var FileItemStatusLocalizer = FileItemLocalizerSelector(localization).status;
    return (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement(Clear, { color: "rgba(255,255,255,0.4)", style: {
...
var PreparingStatus = function (props) {
    ...
    var FileItemStatusLocalizer = FileItemLocalizerSelector(localization).status;
    return (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement(InfiniteLoader, { onClick: onCancel, size: size || 65 }),
        React__namespace.createElement("span", null, FileItemStatusLocalizer.preparing)));
};
...
var SuccessStatus = function (props) {
    ...
    var FileItemStatusLocalizer = FileItemLocalizerSelector(localization).status;
    return (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement(CheckCircle, { color: "#4caf50", size: size || 65 }),
        React__namespace.createElement("span", null,
            " ",
...
var DynamicLoader = function (props) {
    ...
    if (percentage !== undefined)
        return (React__namespace.createElement(LoaderContainer, { size: size },
            React__namespace.createElement(React__namespace.Fragment, null,
                React__namespace.createElement("svg", { className: "dui_svg_circle_loader", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", width: "".concat(finalSize, "px"), height: "".concat(finalSize, "px"), style: finalStyle },
                    React__namespace.createElement("circle", { style: {
                    ...
                    !hidePerncentage && percentage !== undefined && (React__namespace.createElement("text", { className: "files-ui-text-dynamic-loader", x: "".concat(finalX), y: "".concat((finalX * 7) / 6) }, "".concat(percentage.toFixed(0), " %")))),
                onClick && (React__namespace.createElement("div", { style: {
                        position: "absolute",
                        width: "100%",
                        height: "100%",
                        display: "flex",
                    ...
                    React__namespace.createElement(Clear, { color: "rgba(255,255,255,0.75)", size: 45, onClick: onClick }))))));
    else {
        return React__namespace.createElement(React__namespace.Fragment, null);
    }
};
...
var UploadingStatus = function (props) {
    ...
    var FileItemStatusLocalizer = FileItemLocalizerSelector(localization).status;
    return (React__namespace.createElement(React__namespace.Fragment, null,
        progress !== undefined ? (React__namespace.createElement(DynamicLoader, { size: 70, x: 35, y: 35, radius: 32, percentage: progress, width: 6, hidePerncentage: progress === undefined || onAbort !== undefined, onClick: onAbort })) : (React__namespace.createElement(InfiniteLoader, { onClick: onAbort, size: size || 70 })),
        React__namespace.createElement("span", null,
            " ",
...
var FileCardUploadLayer = function (props) {
    ...
    return (React__namespace.createElement("div", { className: "elevation-layer-container", ref: elevationContainerRef },
        React__namespace.createElement("div", { className: "elevation-list-card", ref: listContainerStoryRef }, statusHistory.map(function (status, index) {
            switch (status) {
                case "preparing":
                    return (React__namespace.createElement("div", { className: "elevation-item-card", key: index + 1 },
                        React__namespace.createElement(PreparingStatus, { onCancel: onCancel, localization: localization })));
                case "uploading":
                    return (React__namespace.createElement("div", { className: "elevation-item-card", key: index + 1 },
                        React__namespace.createElement(UploadingStatus, { onAbort: onAbort, progress: progress, localization: localization })));
                case "error":
                    return (React__namespace.createElement("div", { className: "elevation-item-card", key: index + 1 },
                        React__namespace.createElement(ErrorStatus, { size: 60, localization: localization })));
                case "success":
                    return (React__namespace.createElement("div", { className: "elevation-item-card", key: index + 1 },
                        React__namespace.createElement(SuccessStatus, { localization: localization })));
                case "aborted":
                    return (React__namespace.createElement("div", { className: "elevation-item-card", key: index + 1 },
                        React__namespace.createElement(AbortedStatus, { localization: localization })));
                default:
                    return (React__namespace.createElement("div", { className: "elevation-item-card", key: index + 1 },
                        React__namespace.createElement(EmptyStatus, null)));
            }
        }))));
};
...
var Tooltip = function (props) {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null, open && message && statusClassName && (React__namespace.createElement("span", { className: "files-ui-tooltiptext ".concat(statusClassName) }, message))));
};
...
var DownloadHidden = function (props) {
    ...
    if (downloadUrl)
        return (React__namespace.createElement("a", { ref: anchorRef, target: "_blank", href: downloadUrl, download: fileName, hidden: true, rel: "noopener noreferrer", onClick: handleClick }, "download_file"));
    return React__namespace.createElement(React__namespace.Fragment, null);
};
...
var LayerContainer = function (props) {
    ...
    return (React__namespace.createElement("div", { className: finalClassName, style: style }, children));
};

var FileMosaicName = function (props) {
    var fileName = props.fileName;
    if (fileName)
        return React__namespace.createElement("span", null, fileName);
    else {
        return React__namespace.createElement(React__namespace.Fragment, null);
    }
};
...
var FileMosaicUploadLayer = function (props) {
    ...
    //default phase
    return (React__namespace.createElement("div", { className: "elevation-layer-container", ref: elevationContainerRef },
        React__namespace.createElement("div", { className: "elevation-list", ref: listContainerStoryRef }, statusHistory.map(function (status, index) {
            switch (status) {
                case "preparing":
                    return (React__namespace.createElement("div", { className: "elevation-item", key: index + 1 },
                        React__namespace.createElement(PreparingStatus, { onCancel: onCancel, localization: localization })));
                case "uploading":
                    return (React__namespace.createElement("div", { className: "elevation-item", key: index + 1 },
                        React__namespace.createElement(UploadingStatus, { onAbort: onAbort, progress: progress, localization: localization })));
                case "error":
                    return (React__namespace.createElement("div", { className: "elevation-item", key: index + 1 },
                        React__namespace.createElement(ErrorStatus, { localization: localization })));
                case "success":
                    return (React__namespace.createElement("div", { className: "elevation-item", key: index + 1 },
                        React__namespace.createElement(SuccessStatus, { localization: localization })));
                case "aborted":
...
var FileMosaicImageLayer = function (props) {
    ...
    //If blur is true
    if (isBlur) {
        return (React__namespace.createElement(React__namespace.Fragment, null, !card && !error && imageSource && (React__namespace.createElement(ImagePreview, { src: localSource, alt: "blur ".concat(fileName), smartImgFit: false }))));
    }
    return (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement(ImagePreview, { onError: handleError, src: localSource, style: { borderRadius: "0px" }, alt: "preview ".concat(fileName), smartImgFit: smartImgFit })));
};
...
var FileMosaicStatus = function (props) {
    ...
    var FileItemStatusLocalizer = FileItemLocalizerSelector(localization).status;
    if (uploadStatus === "success") {
        return (React__namespace.createElement("div", { className: "files-ui-file-item-status-container file-status-ok", style: style },
            React__namespace.createElement(CloudDone, { color: "#4caf50", size: "small", className: "status-icon" }),
            FileItemStatusLocalizer.success));
    }
    if (uploadStatus === "error" || uploadStatus === "aborted") {
        return (React__namespace.createElement("div", { className: "files-ui-file-item-status-container file-status-error", style: style },
            React__namespace.createElement(UploadError, { color: "#f44336", size: "semi-medium", className: "status-icon" }),
            FileItemStatusLocalizer.error));
    }
    if (valid !== undefined && valid !== null) {
        if (valid) {
            return (React__namespace.createElement("div", { className: "files-ui-file-item-status-container file-status-ok", style: style },
                React__namespace.createElement(CheckCircle, { color: "#4caf50", size: "small", className: "status-icon" }),
                FileItemStatusLocalizer.valid));
        }
        else {
            return (React__namespace.createElement("div", { className: "files-ui-file-item-status-container file-status-error", style: style },
                React__namespace.createElement(DoDisturb, { color: "#f44336", size: "small", className: "status-icon" }),
...
var FileMosaicInfoLayer = function (props) {
    ...
    var _a = FileItemLocalizer.fullInfoLayer, nameLabel = _a.name, sizeLabel = _a.size, typeLabel = _a.type;
    return (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement("div", { className: "files-ui-file-mosaic-info-layer-header" },
            React__namespace.createElement(Cancel
            //style={{ margin: 0, right: 0, top: 0 }}
            , { 
                //style={{ margin: 0, right: 0, top: 0 }}
                color: "rgba(255,255,255,0.8)", onClick: onCloseInfo, colorFill: "black" }),
            React__namespace.createElement(FileMosaicStatus, { valid: valid, uploadStatus: uploadStatus, localization: localization })),
        React__namespace.createElement("div", { className: "heading" }, nameLabel),
        React__namespace.createElement("div", { className: "label" }, localName),
        React__namespace.createElement("div", { className: "heading" }, sizeLabel),
        React__namespace.createElement("div", { className: "label" }, sizeFormatted),
...
var FileMosaicSize = function (props) {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null, sizeFormatted && (React__namespace.createElement("div", { className: "filesui-file-item-size" }, sizeFormatted))));
};
...
var FileMosaicMainLayer = function (props) {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement("div", { className: "file-mosaic-main-layer-header" }, isActive && deleteIcon && (React__namespace.createElement(Clear, { className: darkMode ? "files-ui-file-icon dark-mode" : "files-ui-file-icon", color: darkMode ? "#121212" : "rgba(255,255,255,0.851)", onClick: onDelete, size: "small", colorFill: "transparent" }))),
        React__namespace.createElement("div", { className: "file-mosaic-main-layer-footer" },
            React__namespace.createElement("div", { className: "file-mosaic-footer-left" },
                React__namespace.createElement(FileMosaicStatus, { valid: valid, uploadStatus: uploadStatus, localization: localization }),
                isActive && sizeFormatted && (React__namespace.createElement(FileMosaicSize, { sizeFormatted: sizeFormatted }))),
            React__namespace.createElement("div", { className: "file-mosaic-footer-right" }, isActive && (React__namespace.createElement(React__namespace.Fragment, null,
                imageIcon && (React__namespace.createElement(Visibility, { className: darkMode
                        ? "files-ui-file-icon dark-mode"
                        : "files-ui-file-icon", color: darkMode ? "#121212" : "rgba(255,255,255,0.851)", onClick: onSee, size: "small" })),
                videoIcon && (React__namespace.createElement(PlayIcon, { className: darkMode
...
var FileMosaic = function (props) {
    ...
    if (isReady)
        return (React__namespace.createElement("div", { className: finalClassName, style: style, onClick: handleClick, onMouseEnter: handleOnHoverEnter, onMouseLeave: handleOnHoverLeave, onDoubleClick: handleDoubleClick, onContextMenu: handleRightClick },
            React__namespace.createElement(LayerContainer, { className: "files-ui-file-mosaic-icon-layer-container", style: style },
                React__namespace.createElement(Layer, { className: "files-ui-file-mosaic-image-layer blur", visible: backgroundBlurImage },
                    React__namespace.createElement(FileMosaicImageLayer, { imageSource: imageSource, url: url, fileName: localName, isBlur: true, smartImgFit: false })),
                React__namespace.createElement(Layer, { className: "files-ui-file-mosaic-image-layer", visible: true },
                    React__namespace.createElement(FileMosaicImageLayer, { imageSource: imageSource, url: url, fileName: localName, isBlur: false, smartImgFit: smartImgFit })),
                React__namespace.createElement(Layer, { className: "files-ui-file-mosaic-main-layer", visible: !isUploading && !showInfo },
                    React__namespace.createElement(FileMosaicMainLayer, { deleteIcon: onDelete !== undefined, onDelete: handleDelete, darkMode: darkMode, valid: valid, uploadStatus: uploadStatus, localization: localization, sizeFormatted: sizeFormatted, imageIcon: isImage && onSee !== undefined, onSee: function () { return onSee === null || onSee === void 0 ? void 0 : onSee(imageSource); }, videoIcon: isVideo && onWatch !== undefined, onWatch: function () { return onWatch === null || onWatch === void 0 ? void 0 : onWatch(videoSource); }, downloadIcon: onDownload !== undefined || downloadUrl !== undefined, onDownload: handleDownload, infoIcon: info !== undefined, onOpenInfo: handleOpenInfo, isActive: alwaysActive || hovering })),
                React__namespace.createElement(Layer, { className: "files-ui-file-mosaic-info-layer", visible: showInfo, onClick: handleClickUtil },
                    React__namespace.createElement(FileMosaicInfoLayer, { onCloseInfo: handleCloseInfo, valid: valid, localization: localization, localName: localName, sizeFormatted: sizeFormatted, localType: localType })),
                React__namespace.createElement(Layer, { className: "files-ui-file-mosaic-upload-layer", visible: isUploading, onClick: handleClickUtil },
                    React__namespace.createElement(FileMosaicUploadLayer, { uploadStatus: uploadStatus, progress: localProgress, onCancel: onCancel ? function () { return onCancel === null || onCancel === void 0 ? void 0 : onCancel(id); } : undefined, onAbort: onAbort ? handleAbort : undefined, localization: localization }))),
            React__namespace.createElement("div", { className: fileMosaicFileNameClassName },
                React__namespace.createElement(FileMosaicName, { fileName: localName })),
            React__namespace.createElement(Tooltip, { open: resultOnTooltip, uploadStatus: uploadStatus, valid: valid, errors: errors, uploadMessage: uploadMessage }),
            React__namespace.createElement(DownloadHidden, { fileName: localName, anchorRef: downloadRef, downloadUrl: downloadUrl })));
    return React__namespace.createElement(React__namespace.Fragment, null);
};
...
var FileCard = function (props) {
    ...
    if (isReady) {
        return (React__namespace.createElement("div", { className: finalClassName, style: style, onClick: handleClick, onMouseEnter: handleOnHoverEnter, onMouseLeave: handleOnHoverLeave, onDoubleClick: handleDoubleClick, onContextMenu: handleRightClick },
            React__namespace.createElement(LayerContainer, { className: "files-ui-file-card-main-layer-container" },
                React__namespace.createElement(Layer, { className: "file-card-main-layer", visible: true },
                    React__namespace.createElement("div", { className: "file-card-icon-plus-data" },
                        React__namespace.createElement("div", { className: "file-card-icon-container" },
                            React__namespace.createElement(LayerContainer, { className: "file-card-icon-layer" },
                                React__namespace.createElement(Layer, { className: "file-card-icon-layer blur", visible: backgroundBlurImage },
                                    React__namespace.createElement(FileMosaicImageLayer, { imageSource: imageSource, fileName: localName, url: url, isBlur: true, smartImgFit: false })),
                                React__namespace.createElement(Layer, { className: "file-card-icon-layer", visible: true },
                                    React__namespace.createElement(FileMosaicImageLayer, { imageSource: imageSource, url: url, fileName: localName, isBlur: false, smartImgFit: smartImgFit })),
                                React__namespace.createElement(Layer, { className: "file-card-status-layer", visible: true },
                                    React__namespace.createElement(FileMosaicStatus, { valid: valid, uploadStatus: uploadStatus, localization: localization })))),
                        React__namespace.createElement("div", { className: darkMode ? "file-card-data dark-mode" : "file-card-data" },
                            React__namespace.createElement("div", { className: "file-card-name" }, localName),
                            React__namespace.createElement("div", { className: "file-card-size" }, sizeFormatted),
                            React__namespace.createElement("div", { className: "file-card-size" }, shrinkWord(localType))))),
                React__namespace.createElement(Layer, { className: "file-card-info-layer-container", visible: showInfo, onClick: handleClickUtil },
                    React__namespace.createElement(FileCardInfoLayer, { onCloseInfo: handleCloseInfo, valid: valid, localization: localization, localName: localName, sizeFormatted: sizeFormatted, localType: localType })),
                React__namespace.createElement(Layer, { className: "file-card-upload-layer-container", visible: isUploading, onClick: handleClickUtil },
                    React__namespace.createElement("div", { className: "files-ui-file-card-upload-layer" },
                        React__namespace.createElement(FileCardUploadLayer, { uploadStatus: uploadStatus, progress: localProgress, onCancel: onCancel ? function () { return onCancel === null || onCancel === void 0 ? void 0 : onCancel(id); } : undefined, onAbort: onAbort ? handleAbort : undefined, localization: localization })))),
            React__namespace.createElement(FileCardRightActions, { deleteIcon: onDelete !== undefined, onDelete: handleDelete, darkMode: darkMode, imageIcon: isImage && onSee !== undefined, onSee: function () { return onSee === null || onSee === void 0 ? void 0 : onSee(imageSource); }, videoIcon: isVideo && onWatch !== undefined, onWatch: function () { return onWatch === null || onWatch === void 0 ? void 0 : onWatch(videoSource); }, downloadIcon: onDownload !== undefined || downloadUrl !== undefined, onDownload: handleDownload, infoIcon: info !== undefined, onOpenInfo: handleOpenInfo, isActive: alwaysActive || hovering, visible: !isUploading && !showInfo }),
            React__namespace.createElement(Tooltip, { open: resultOnTooltip, uploadStatus: uploadStatus, valid: valid, errors: errors, uploadMessage: uploadMessage }),
            React__namespace.createElement(DownloadHidden, { fileName: localName, anchorRef: downloadRef, downloadUrl: downloadUrl })));
    }
    return React__namespace.createElement(React__namespace.Fragment, null);
...
var FullScreen = function (props) {
    ...
    return (React__namespace.createElement("div", { className: open ? "fui-fullscreen-container show-fs" : "fui-fullscreen-container", onClick: handleClose },
        open && (React__namespace.createElement("div", { className: "fui-fullscreen-relative-container", onClick: handleClose }, children)),
        onClose && (React__namespace.createElement(Clear, { color: "rgba(255,255,255,0.8)", onClick: handleClose, colorFill: "transparent", className: "button-full-screen", size: "extra-large" }))));
};
...
var VideoPreview = function (props) {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null, videoSrc && source && (React__namespace.createElement("video", __assign$1({ onClick: function (evt) {
            evt.preventDefault();
        }, 
        ...
        React__namespace.createElement("source", { type: "video/webm" }),
        React__namespace.createElement("source", { type: "video/ogg" }),
        React__namespace.createElement("source", { type: "video/mp4" })))));
};

var FilesUiProvider = function (props) {
    var children = props.children, config = props.config;
    return (React__namespace.createElement(FilesUiContext.Provider, { value: config || {} }, children));
};
